...
public class StringRelatedAssertionTests {
    ...
    public void testStringAssertions () {
        ...
        // Προτάσεις πριν κάνεις τα χειροκίνητα assertions (Human-in-the-Loop)
        String suggestions = ai.suggestRestAssuredAssertions(json);
        System.out.println("🤖 AI suggested assertions:\n" + suggestions);

        // Προαιρετικά: σύνοψη για το report
        String summary = ai.summarizeResponse(json);
        System.out.println("🤖 AI summary:\n" + summary);

        // Τα κανονικά σου assertions παραμένουν:
